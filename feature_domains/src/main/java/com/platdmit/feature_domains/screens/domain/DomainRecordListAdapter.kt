...
class DomainRecordListAdapter : RecyclerView.Adapter<DomainRecordListAdapter.DomainRecordListHolder>() {
    ...
    inner class DomainRecordListHolder(inflater: LayoutInflater, parent: ViewGroup?, layoutType: Int
