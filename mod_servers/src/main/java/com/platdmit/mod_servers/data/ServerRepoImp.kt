package com.platdmit.mod_servers.data

import com.platdmit.mod_servers.domain.repositories.api.ApiServerRepo
...
class ServerRepoImp : ServerBaseRepo, ServerActionsRepo, ServerStatisticsRepo, ServerBackupRepo, ServerLoadAveragesRepo {
    ...
    private val apiServerRepo: ApiServerRepo<ApiServer, ApiAction, ApiStatistic, ApiBackup, ApiLoadAverage>
    ...
    constructor(
            apiServerRepo: ApiServerRepo<ApiServer, ApiAction, ApiStatistic, ApiBackup, ApiLoadAverage>,
            serverDao: ServerDao,
