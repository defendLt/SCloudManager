...
@Database(entities = [DbAccount::class, DbDomain::class, DbDomainRecord::class, DbServer::class, DbAction::class, DbBackup::class, DbLoadAverage::class, DbStatistic::class, DbUpdateSchedule::class], version = 1, exportSchema = false)
