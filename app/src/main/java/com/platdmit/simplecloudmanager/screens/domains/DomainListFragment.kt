...
class DomainListFragment : Fragment(R.layout.fragment_domains_list){
    ...
    private val domainListAdapter: DomainListAdapter = DomainListAdapter(::recyclerItemsClickListener)
    ...
    private fun recyclerItemsClickListener(domain: Domain){
        findNavController().navigate(R.id.domainFragment, bundleOf("ELEMENT_ID" to domain.id))
    }
}