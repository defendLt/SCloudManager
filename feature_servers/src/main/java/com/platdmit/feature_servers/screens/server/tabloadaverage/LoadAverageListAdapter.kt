...
import com.platdmit.feature_servers.R
import com.platdmit.feature_servers.domain.models.LoadAverage

class LoadAverageListAdapter : RecyclerView.Adapter<LoadAverageListAdapter.LoadAverageListHolder>() {
    ...
    inner class LoadAverageListHolder(inflater: LayoutInflater, parent: ViewGroup?, layoutType: Int
