...
class BackupListAdapter : RecyclerView.Adapter<BackupListAdapter.BackupListHolder>() {
    ...
    inner class BackupListHolder(inflater: LayoutInflater, parent: ViewGroup?, layoutType: Int
