...
class ServerTabStatisticsFragment(
    ...
    private fun updateCpuData(cpuData: _root_ide_package_.com.platdmit.feature_servers.domain.models.ComplexChartsData) {
        try {
    ...
    private fun updateRamData(ramData: _root_ide_package_.com.platdmit.feature_servers.domain.models.ComplexChartsData) {
        try {
