...
class ServerListAdapter : RecyclerView.Adapter<ServerListAdapter.ServerListHolder>() {
    ...
    inner class ServerListHolder(inflater: LayoutInflater, parent: ViewGroup?, layoutType: Int
